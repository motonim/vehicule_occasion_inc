...
<div class="container py-5">
   <div class="row">
      <div class="produit__panier__section col-12 col-lg-8">
         ...
         <!-- --------formulaire Réserver-------- -->
         <div class="border--gray border-radius__5px p-2 mt-3" data-js-formulaire-reserver>         
         ...
         <!-- --------formulaire Payer-------- -->
         <div class="border--gray border-radius__5px p-2 mt-3" data-js-formulaire-payer>         
            <h2 class='p-2'>Information</h2>
            <div class="py-3 px-2">
               <label for="courriel">@lang('auth.email') *</label>
               <div class="">
